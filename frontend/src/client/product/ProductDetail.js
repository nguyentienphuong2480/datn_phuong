                                ...
                                <div className="carousel-inner product-links-wap" role="listbox">
                                    <div className="carousel-item active">
                                        <div className="row">
                                            <div className="col-4">
                                                <Link>
                                                    <img className="card-img img-fluid" src="client/assets/img/product_single_01.jpg" alt="1" />
                                                </Link>
                                            </div>
                                            <div className="col-4">
                                                <Link>
                                                    <img className="card-img img-fluid" src="client/assets/img/product_single_02.jpg" alt="2" />
                                                </Link>
                                            </div>
                                            <div className="col-4">
                                                <Link>
                                                    <img className="card-img img-fluid" src="client/assets/img/product_single_03.jpg" alt="3" />
                                                </Link>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="carousel-item">
                                        <div className="row">
                                            <div className="col-4">
                                                <Link>
                                                    <img className="card-img img-fluid" src="client/assets/img/product_single_04.jpg" alt="4" />
                                                </Link>
                                            </div>
                                            <div className="col-4">
                                                <Link>
                                                    <img className="card-img img-fluid" src="client/assets/img/product_single_05.jpg" alt="5" />
                                                </Link>
                                            </div>
                                            <div className="col-4">
                                                <Link>
                                                    <img className="card-img img-fluid" src="client/assets/img/product_single_06.jpg" alt="6" />
                                                </Link>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="carousel-item">
                                        <div className="row">
                                            <div className="col-4">
                                                <Link>
                                                    <img className="card-img img-fluid" src="client/assets/img/product_single_07.jpg" alt="7" />
                                                </Link>
                                            </div>
                                            <div className="col-4">
                                                <Link>
                                                    <img className="card-img img-fluid" src="client/assets/img/product_single_08.jpg" alt="8" />
                                                </Link>
                                            </div>
                                            <div className="col-4">
                                                <Link>
                                                    <img className="card-img img-fluid" src="client/assets/img/product_single_09.jpg" alt="9" />
                                                </Link>
                                            </div>
                                        </div>
                                    </div>
