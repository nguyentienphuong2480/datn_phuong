                ...
                <aside id="layout-menu" className="layout-menu menu-vertical menu bg-menu-theme">
                    ...
                    <ul className="menu-inner py-1">
                        ...
                        <li className="menu-item">
                            <Link to="/dashboard/listBrand" className="menu-link">
                                <i className="menu-icon tf-icons bx bx-home-circle" />
                                <div data-i18n="Analytics">Brand</div>
                            </Link>
                        </li>
                        <li className="menu-item">
                            <Link to="/dashboard/listCategory" className="menu-link">
                                <i className="menu-icon tf-icons bx bx-home-circle" />
                                <div data-i18n="Analytics">Category</div>
                            </Link>
                        </li>
                        <li className="menu-item">
                            <Link to="/dashboard/listSubcategory" className="menu-link">
                                <i className="menu-icon tf-icons bx bx-home-circle" />
                                <div data-i18n="Analytics">Subcategory</div>
                            </Link>
                        </li>
                        <li className="menu-item">
                            <Link to="/dashboard/listProduct" className="menu-link">
                                <i className="menu-icon tf-icons bx bx-home-circle" />
                                <div data-i18n="Analytics">Product</div>
                            </Link>
                        </li>
                        <li className="menu-item">
                            <Link to="/dashboard/listUser" className="menu-link">
                                <i className="menu-icon tf-icons bx bx-home-circle" />
                                ...
                                <li className="nav-item navbar-dropdown dropdown-user dropdown">
                                    <a className="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                                        <div className="avatar avatar-online">
                                            <img src="../admin/assets/img/avatars/1.png" alt="" className="w-px-40 h-auto rounded-circle" />
                                        </div>
                                    </a>
